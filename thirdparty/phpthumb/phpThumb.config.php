...
$PHPTHUMB_CONFIG['cache_directory'] = FLUTTER_IMAGES_CACHE_DIR;                                           // set the cache directory relative to the source image - must start with '.' (will not work to cache URL- or database-sourced images, please use an absolute directory name)
...
$PHPTHUMB_CONFIG['cache_source_directory'] = FLUTTER_IMAGES_CACHE_DIR.'/source/';  // set the cache directory for unprocessed source images
